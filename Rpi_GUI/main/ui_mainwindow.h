...
public:
    ...
    QLabel *humid_recent_lbl;
    QLabel *co2_recent_lbl;
    QLabel *temp_setting_lbl;
    QLabel *humid_setting_lbl;
    QLabel *co2_setting_lbl;
    QLabel *show_water;
    QLabel *show_sun;
    QLabel *show_co2;
    QLabel *show_wind;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        recent_logo->setGeometry(QRect(162, 99, 95, 29));
        ...
        setting_logo->setGeometry(QRect(325, 99, 95, 29));
        ...
        temp_img->setGeometry(QRect(43, 153, 72, 72));
        ...
        humid_img->setGeometry(QRect(52, 251, 55, 55));
        ...
        co2_img->setGeometry(QRect(52, 341, 55, 55));
        ...
        temp_recent_lbl->setGeometry(QRect(135, 151, 148, 75));
        temp_recent_lbl->setStyleSheet(QString::fromUtf8("background-color: rgb(61, 91, 101);"));
        humid_recent_lbl = new QLabel(centralwidget);
        humid_recent_lbl->setObjectName(QString::fromUtf8("humid_recent_lbl"));
        humid_recent_lbl->setGeometry(QRect(135, 241, 148, 75));
        humid_recent_lbl->setStyleSheet(QString::fromUtf8("background-color: rgb(61, 91, 101);"));
        co2_recent_lbl = new QLabel(centralwidget);
        co2_recent_lbl->setObjectName(QString::fromUtf8("co2_recent_lbl"));
        co2_recent_lbl->setGeometry(QRect(135, 331, 148, 75));
        co2_recent_lbl->setStyleSheet(QString::fromUtf8("background-color: rgb(61, 91, 101);"));
        temp_setting_lbl = new QLabel(centralwidget);
        temp_setting_lbl->setObjectName(QString::fromUtf8("temp_setting_lbl"));
        temp_setting_lbl->setGeometry(QRect(298, 151, 156, 75));
        temp_setting_lbl->setStyleSheet(QString::fromUtf8("background-color: rgb(61, 91, 101);"));
        humid_setting_lbl = new QLabel(centralwidget);
        humid_setting_lbl->setObjectName(QString::fromUtf8("humid_setting_lbl"));
        humid_setting_lbl->setGeometry(QRect(298, 241, 156, 75));
        humid_setting_lbl->setStyleSheet(QString::fromUtf8("background-color: rgb(61, 91, 101);"));
        co2_setting_lbl = new QLabel(centralwidget);
        co2_setting_lbl->setObjectName(QString::fromUtf8("co2_setting_lbl"));
        co2_setting_lbl->setGeometry(QRect(298, 331, 156, 75));
        co2_setting_lbl->setStyleSheet(QString::fromUtf8("background-color: rgb(61, 91, 101);"));
        show_water = new QLabel(centralwidget);
        show_water->setObjectName(QString::fromUtf8("show_water"));
        show_water->setGeometry(QRect(542, 170, 100, 100));
        ...
        show_sun->setGeometry(QRect(658, 170, 100, 100));
        ...
        show_co2->setGeometry(QRect(542, 285, 101, 100));
        ...
        show_wind->setGeometry(QRect(658, 285, 100, 100));
        ...
        pot_logo->setGeometry(QRect(565, 192, 55, 55));
...
"image: url(:/images/logo_pot.png);"));
        ...
        sun_logo->setGeometry(QRect(680, 192, 55, 55));
        ...
        cloud_logo->setGeometry(QRect(565, 307, 55, 55));
        ...
        wind_logo->setGeometry(QRect(680, 307, 55, 55));
        ...
        c_recent_logo->setGeometry(QRect(228, 166, 45, 45));
        ...
        percent_recent_logo->setGeometry(QRect(228, 256, 45, 45));
        ...
        ppm_recent_logo->setGeometry(QRect(228, 357, 45, 24));
        ...
        temp_text->setGeometry(QRect(305, 159, 96, 60));
        ...
        humid_text->setGeometry(QRect(305, 249, 96, 60));
        ...
        co2_text->setGeometry(QRect(305, 339, 96, 60));
        ...
        uptime_logo->setGeometry(QRect(555, 431, 87, 36));
        ...
        uptime_lbl->setGeometry(QRect(658, 431, 100, 36));
        ...
        h_logo->setGeometry(QRect(736, 437, 13, 24));
        ...
        ppm_setting_logo->setGeometry(QRect(406, 357, 45, 24));
        ...
        c_setting_logo->setGeometry(QRect(406, 166, 45, 45));
        ...
        percent_setting_logo->setGeometry(QRect(406, 256, 45, 45));
        ...
        humid_down_btn->setGeometry(QRect(459, 281, 39, 35));
...
"border:0px;"));
        ...
        humid_up_btn->setGeometry(QRect(459, 241, 39, 35));
...
"border:0px;"));
        ...
        co2_up_btn->setGeometry(QRect(459, 331, 39, 35));
...
"border:0px;"));
        ...
        co2_down_btn->setGeometry(QRect(459, 371, 39, 35));
...
"border:0px;"));
        ...
        temperature_up_btn->setGeometry(QRect(459, 151, 39, 35));
...
"border:0px;"));
        ...
        temperature_down_btn->setGeometry(QRect(459, 191, 39, 35));
...
"border:0px;"));
        ...
        temp_recent_text->setGeometry(QRect(152, 169, 76, 40));
...
"font: 36px;"));
        ...
        humid_recent_text->setGeometry(QRect(152, 259, 76, 40));
...
"font: 36px;"));
        ...
        co2_recent_text->setGeometry(QRect(145, 345, 80, 40));
...
"font: 36px;"));
        ...
        co2_setting_text->setGeometry(QRect(317, 345, 80, 40));
...
"font: 36px;"));
        ...
        humid_setting_text->setGeometry(QRect(315, 259, 76, 40));
...
"font: 36px;"));
        ...
        temp_setting_text->setGeometry(QRect(315, 169, 76, 40));
...
"font: 36px;"));
        ...
        uptime_text->setGeometry(QRect(680, 429, 43, 40));
...
"font: 24px;"));
        ...
        logout_btn->setGeometry(QRect(657, 21, 120, 30));
        logout_btn->setStyleSheet(QString::fromUtf8("border: 0px;\n"
"image: url(:/images/logo logout.png);"));
        pushButton = new QPushButton(centralwidget);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(540, 90, 51, 51));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setGeometry(QRect(590, 90, 51, 51));
        pushButton_3 = new QPushButton(centralwidget);
        pushButton_3->setObjectName(QString::fromUtf8("pushButton_3"));
        pushButton_3->setGeometry(QRect(640, 90, 51, 51));
        pushButton_4 = new QPushButton(centralwidget);
        pushButton_4->setObjectName(QString::fromUtf8("pushButton_4"));
        pushButton_4->setGeometry(QRect(690, 90, 51, 51));
        change_btn = new QPushButton(centralwidget);
        change_btn->setObjectName(QString::fromUtf8("change_btn"));
        change_btn->setGeometry(QRect(298, 419, 200, 42));
...
"font: 24px;"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        humid_recent_lbl->setText(QString());
        co2_recent_lbl->setText(QString());
        temp_setting_lbl->setText(QString());
        humid_setting_lbl->setText(QString());
        co2_setting_lbl->setText(QString());
