...
QT_MOC_LITERAL(1, 7, 17), // "applyServerChange"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4) // "flag"

    },
    "Thread\0applyServerChange\0\0flag"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->applyServerChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::applyServerChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Thread::applyServerChange(int _t1)
{
